class Tarot::Board
  ...
  TILES = [
    ...
    { id: 5, l: { terrain: :wheat, crowns: 50 }, r: { terrain: :wheat, crowns: 0 } },
    ...
    { id: 10, l: { terrain: :wheat, crowns: 50 }, r: { terrain: :village, crowns: 1 } },
    ...
    { id: 16, l: { terrain: :lakes, crowns: 50 }, r: { terrain: :village, crowns: 1 } },
